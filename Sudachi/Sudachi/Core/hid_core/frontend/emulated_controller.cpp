...
NpadStyleIndex EmulatedController::MapSettingsTypeToNPad(YuzuSettings::ControllerType type) {
    switch (type) {
    case YuzuSettings::ControllerType::ProController:
        return NpadStyleIndex::Fullkey;
    case YuzuSettings::ControllerType::DualJoyconDetached:
        return NpadStyleIndex::JoyconDual;
    case YuzuSettings::ControllerType::LeftJoycon:
        return NpadStyleIndex::JoyconLeft;
    case YuzuSettings::ControllerType::RightJoycon:
        return NpadStyleIndex::JoyconRight;
    case YuzuSettings::ControllerType::Handheld:
        return NpadStyleIndex::Handheld;
    case YuzuSettings::ControllerType::GameCube:
        return NpadStyleIndex::GameCube;
    case YuzuSettings::ControllerType::Pokeball:
        return NpadStyleIndex::Pokeball;
    case YuzuSettings::ControllerType::NES:
        return NpadStyleIndex::NES;
    case YuzuSettings::ControllerType::SNES:
        return NpadStyleIndex::SNES;
    case YuzuSettings::ControllerType::N64:
        return NpadStyleIndex::N64;
    case YuzuSettings::ControllerType::SegaGenesis:
...
YuzuSettings::ControllerType EmulatedController::MapNPadToSettingsType(NpadStyleIndex type) {
    switch (type) {
    case NpadStyleIndex::Fullkey:
        return YuzuSettings::ControllerType::ProController;
    case NpadStyleIndex::JoyconDual:
        return YuzuSettings::ControllerType::DualJoyconDetached;
    case NpadStyleIndex::JoyconLeft:
        return YuzuSettings::ControllerType::LeftJoycon;
    case NpadStyleIndex::JoyconRight:
        return YuzuSettings::ControllerType::RightJoycon;
    case NpadStyleIndex::Handheld:
        return YuzuSettings::ControllerType::Handheld;
    case NpadStyleIndex::GameCube:
        return YuzuSettings::ControllerType::GameCube;
    case NpadStyleIndex::Pokeball:
        return YuzuSettings::ControllerType::Pokeball;
    case NpadStyleIndex::NES:
        return YuzuSettings::ControllerType::NES;
    case NpadStyleIndex::SNES:
        return YuzuSettings::ControllerType::SNES;
    case NpadStyleIndex::N64:
        return YuzuSettings::ControllerType::N64;
    case NpadStyleIndex::SegaGenesis:
        return YuzuSettings::ControllerType::SegaGenesis;
    default:
        return YuzuSettings::ControllerType::ProController;
    }
}
...
void EmulatedController::ReloadFromSettings() {
    ...
    ring_params[0] = Common::ParamPackage(YuzuSettings::values.ringcon_analogs);
...
void EmulatedController::LoadDevices() {
    ...
    const auto& left_joycon = button_params[YuzuSettings::NativeButton::DRight];
    const auto& right_joycon = button_params[YuzuSettings::NativeButton::A];

    // Triggers for GC controllers
    trigger_params[LeftIndex] = button_params[YuzuSettings::NativeButton::ZL];
    trigger_params[RightIndex] = button_params[YuzuSettings::NativeButton::ZR];
...
void EmulatedController::LoadTASParams() {
    ...
    tas_button_params[YuzuSettings::NativeButton::A].Set("button", 0);
    tas_button_params[YuzuSettings::NativeButton::B].Set("button", 1);
    tas_button_params[YuzuSettings::NativeButton::X].Set("button", 2);
    tas_button_params[YuzuSettings::NativeButton::Y].Set("button", 3);
    tas_button_params[YuzuSettings::NativeButton::LStick].Set("button", 4);
    tas_button_params[YuzuSettings::NativeButton::RStick].Set("button", 5);
    tas_button_params[YuzuSettings::NativeButton::L].Set("button", 6);
    tas_button_params[YuzuSettings::NativeButton::R].Set("button", 7);
    tas_button_params[YuzuSettings::NativeButton::ZL].Set("button", 8);
    tas_button_params[YuzuSettings::NativeButton::ZR].Set("button", 9);
    tas_button_params[YuzuSettings::NativeButton::Plus].Set("button", 10);
    tas_button_params[YuzuSettings::NativeButton::Minus].Set("button", 11);
    tas_button_params[YuzuSettings::NativeButton::DLeft].Set("button", 12);
    tas_button_params[YuzuSettings::NativeButton::DUp].Set("button", 13);
    tas_button_params[YuzuSettings::NativeButton::DRight].Set("button", 14);
    tas_button_params[YuzuSettings::NativeButton::DDown].Set("button", 15);
    tas_button_params[YuzuSettings::NativeButton::SLLeft].Set("button", 16);
    tas_button_params[YuzuSettings::NativeButton::SRLeft].Set("button", 17);
    tas_button_params[YuzuSettings::NativeButton::Home].Set("button", 18);
    tas_button_params[YuzuSettings::NativeButton::Screenshot].Set("button", 19);
    tas_button_params[YuzuSettings::NativeButton::SLRight].Set("button", 20);
    tas_button_params[YuzuSettings::NativeButton::SRRight].Set("button", 21);

    tas_stick_params[YuzuSettings::NativeAnalog::LStick].Set("axis_x", 0);
    tas_stick_params[YuzuSettings::NativeAnalog::LStick].Set("axis_y", 1);
    tas_stick_params[YuzuSettings::NativeAnalog::RStick].Set("axis_x", 2);
    tas_stick_params[YuzuSettings::NativeAnalog::RStick].Set("axis_y", 3);
    ...
    tas_stick_params[YuzuSettings::NativeAnalog::LStick].Set("deadzone", 0.0f);
    tas_stick_params[YuzuSettings::NativeAnalog::LStick].Set("range", 1.0f);
    tas_stick_params[YuzuSettings::NativeAnalog::RStick].Set("deadzone", 0.0f);
    tas_stick_params[YuzuSettings::NativeAnalog::RStick].Set("range", 1.0f);
}
...
void EmulatedController::LoadVirtualGamepadParams() {
    ...
    // TODO(german77): Replace this with an input profile or something better
    virtual_button_params[YuzuSettings::NativeButton::A].Set("button", 0);
    virtual_button_params[YuzuSettings::NativeButton::B].Set("button", 1);
    virtual_button_params[YuzuSettings::NativeButton::X].Set("button", 2);
    virtual_button_params[YuzuSettings::NativeButton::Y].Set("button", 3);
    virtual_button_params[YuzuSettings::NativeButton::LStick].Set("button", 4);
    virtual_button_params[YuzuSettings::NativeButton::RStick].Set("button", 5);
    virtual_button_params[YuzuSettings::NativeButton::L].Set("button", 6);
    virtual_button_params[YuzuSettings::NativeButton::R].Set("button", 7);
    virtual_button_params[YuzuSettings::NativeButton::ZL].Set("button", 8);
    virtual_button_params[YuzuSettings::NativeButton::ZR].Set("button", 9);
    virtual_button_params[YuzuSettings::NativeButton::Plus].Set("button", 10);
    virtual_button_params[YuzuSettings::NativeButton::Minus].Set("button", 11);
    virtual_button_params[YuzuSettings::NativeButton::DLeft].Set("button", 12);
    virtual_button_params[YuzuSettings::NativeButton::DUp].Set("button", 13);
    virtual_button_params[YuzuSettings::NativeButton::DRight].Set("button", 14);
    virtual_button_params[YuzuSettings::NativeButton::DDown].Set("button", 15);
    virtual_button_params[YuzuSettings::NativeButton::SLLeft].Set("button", 16);
    virtual_button_params[YuzuSettings::NativeButton::SRLeft].Set("button", 17);
    virtual_button_params[YuzuSettings::NativeButton::Home].Set("button", 18);
    virtual_button_params[YuzuSettings::NativeButton::Screenshot].Set("button", 19);
    virtual_button_params[YuzuSettings::NativeButton::SLRight].Set("button", 20);
    virtual_button_params[YuzuSettings::NativeButton::SRRight].Set("button", 21);

    virtual_stick_params[YuzuSettings::NativeAnalog::LStick].Set("axis_x", 0);
    virtual_stick_params[YuzuSettings::NativeAnalog::LStick].Set("axis_y", 1);
    virtual_stick_params[YuzuSettings::NativeAnalog::RStick].Set("axis_x", 2);
    virtual_stick_params[YuzuSettings::NativeAnalog::RStick].Set("axis_y", 3);
    virtual_stick_params[YuzuSettings::NativeAnalog::LStick].Set("deadzone", 0.0f);
    virtual_stick_params[YuzuSettings::NativeAnalog::LStick].Set("range", 1.0f);
    virtual_stick_params[YuzuSettings::NativeAnalog::RStick].Set("deadzone", 0.0f);
    virtual_stick_params[YuzuSettings::NativeAnalog::RStick].Set("range", 1.0f);

    virtual_motion_params[YuzuSettings::NativeMotion::MotionLeft].Set("motion", 0);
    virtual_motion_params[YuzuSettings::NativeMotion::MotionRight].Set("motion", 0);
}
...
void EmulatedController::SaveCurrentConfig() {
    ...
    if (npad_id_type == NpadIdType::Player1) {
        YuzuSettings::values.ringcon_analogs = ring_params[0].Serialize();
    }
}
...
void EmulatedController::SetButton(const Common::Input::CallbackStatus& callback, std::size_t index,
    ...
    if (npad_type == NpadStyleIndex::GameCube) {
        if (index == YuzuSettings::NativeButton::ZR) {
            return;
        }
        if (index == YuzuSettings::NativeButton::ZL) {
            return;
        }
    }

    switch (index) {
    case YuzuSettings::NativeButton::A:
        controller.npad_button_state.a.Assign(current_status.value);
        controller.debug_pad_button_state.a.Assign(current_status.value);
        break;
    case YuzuSettings::NativeButton::B:
        ...
        break;
    case YuzuSettings::NativeButton::X:
        ...
        break;
    case YuzuSettings::NativeButton::Y:
    ...
    case YuzuSettings::NativeButton::L:
        ...
        break;
    case YuzuSettings::NativeButton::R:
        ...
        break;
    case YuzuSettings::NativeButton::ZL:
        ...
        break;
    case YuzuSettings::NativeButton::ZR:
        ...
        break;
    case YuzuSettings::NativeButton::Plus:
        ...
        break;
    case YuzuSettings::NativeButton::Minus:
        ...
        break;
    case YuzuSettings::NativeButton::DLeft:
        ...
        break;
    case YuzuSettings::NativeButton::DUp:
        ...
        break;
    case YuzuSettings::NativeButton::DRight:
        ...
        break;
    case YuzuSettings::NativeButton::DDown:
        controller.npad_button_state.down.Assign(current_status.value);
        controller.debug_pad_button_state.d_down.Assign(current_status.value);
        break;
    case YuzuSettings::NativeButton::SLLeft:
        controller.npad_button_state.left_sl.Assign(current_status.value);
        break;
    case YuzuSettings::NativeButton::SLRight:
        controller.npad_button_state.right_sl.Assign(current_status.value);
        break;
    case YuzuSettings::NativeButton::SRLeft:
        controller.npad_button_state.left_sr.Assign(current_status.value);
        break;
    case YuzuSettings::NativeButton::SRRight:
        controller.npad_button_state.right_sr.Assign(current_status.value);
        break;
    case YuzuSettings::NativeButton::Home:
        if (!system_buttons_enabled) {
            break;
        }
        controller.home_button_state.home.Assign(current_status.value);
        break;
    case YuzuSettings::NativeButton::Screenshot:
        if (!system_buttons_enabled) {
            break;
        }
...
void EmulatedController::SetStick(const Common::Input::CallbackStatus& callback, std::size_t index,
    ...
    switch (index) {
    case YuzuSettings::NativeAnalog::LStick:
        ...
        break;
    case YuzuSettings::NativeAnalog::RStick:
...
void EmulatedController::SetTrigger(const Common::Input::CallbackStatus& callback,
    ...
    switch (index) {
    case YuzuSettings::NativeTrigger::LTrigger:
        ...
        break;
    case YuzuSettings::NativeTrigger::RTrigger:
...
bool EmulatedController::SetVibration(DeviceIndex device_index, const VibrationValue& vibration) {
    ...
    if (last_vibration_value[index] == vibration) {
        return YuzuSettings::values.vibration_enabled.GetValue();
    }

    last_vibration_value[index] = vibration;

    if (!YuzuSettings::values.vibration_enabled) {
        return false;
    }
    ...
    if (!YuzuSettings::values.enable_accurate_vibrations.GetValue()) {
