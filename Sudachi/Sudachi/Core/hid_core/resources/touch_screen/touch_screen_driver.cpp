...
Result TouchDriver::WaitForInput() {
    ...
    for (std::size_t id = 0; id < MaxFingers; ++id) {
        ...
        if (id < active_fingers_count) {
            ...
            touch_entry.diameter_x = YuzuSettings::values.touchscreen.diameter_x;
            touch_entry.diameter_y = YuzuSettings::values.touchscreen.diameter_y;
            touch_entry.rotation_angle = YuzuSettings::values.touchscreen.rotation_angle;
