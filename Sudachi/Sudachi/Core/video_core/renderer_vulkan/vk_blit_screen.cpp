...
void BlitScreen::SetWindowAdaptPass() {
    ...
    case YuzuSettings::ScalingFilter::NearestNeighbor:
        window_adapt = MakeNearestNeighbor(device, swapchain_view_format);
        break;
    case YuzuSettings::ScalingFilter::Bicubic:
        window_adapt = MakeBicubic(device, swapchain_view_format);
        break;
    case YuzuSettings::ScalingFilter::Gaussian:
        window_adapt = MakeGaussian(device, swapchain_view_format);
        break;
    case YuzuSettings::ScalingFilter::ScaleForce:
        window_adapt = MakeScaleForce(device, swapchain_view_format);
        break;
    case YuzuSettings::ScalingFilter::Fsr:
    case YuzuSettings::ScalingFilter::Bilinear:
    default:
