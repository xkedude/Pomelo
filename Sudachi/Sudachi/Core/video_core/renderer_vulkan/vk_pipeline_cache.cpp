...
PipelineCache::PipelineCache(Tegra::MaxwellDeviceMemoryManager& device_memory_,
    ...
    : VideoCommon::ShaderCache{device_memory_}, device{device_}, scheduler{scheduler_},
      ...
      use_asynchronous_shaders{YuzuSettings::values.use_asynchronous_shaders.GetValue()},
      use_vulkan_pipeline_cache{YuzuSettings::values.use_vulkan_driver_pipeline_cache.GetValue()},
...
std::unique_ptr<GraphicsPipeline> PipelineCache::CreateGraphicsPipeline(
    ...
    for (size_t index = 0; index < Maxwell::MaxShaderProgram; ++index) {
        ...
        if (YuzuSettings::values.dump_shaders) {
