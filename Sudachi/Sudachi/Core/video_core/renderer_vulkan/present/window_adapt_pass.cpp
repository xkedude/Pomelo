...
void WindowAdaptPass::Draw(RasterizerVulkan& rasterizer, Scheduler& scheduler, size_t image_index,
    ...
    scheduler.Record([=](vk::CommandBuffer cmdbuf) {
        const f32 bg_red = YuzuSettings::values.bg_red.GetValue() / 255.0f;
        const f32 bg_green = YuzuSettings::values.bg_green.GetValue() / 255.0f;
        const f32 bg_blue = YuzuSettings::values.bg_blue.GetValue() / 255.0f;
