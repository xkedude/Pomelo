...
Joycons::Joycons(const std::string& input_engine_) : InputEngine(input_engine_) {
    ...
    if (!YuzuSettings::values.enable_joycon_driver && !YuzuSettings::values.enable_procon_driver) {
        return;
    }
...
ButtonMapping Joycons::GetButtonMappingForDevice(const Common::ParamPackage& params) {
    static constexpr std::array<std::tuple<YuzuSettings::NativeButton::Values, Joycon::PadButton, bool>,
                                18>
        switch_to_joycon_button = {
            std::tuple{YuzuSettings::NativeButton::A, Joycon::PadButton::A, true},
            {YuzuSettings::NativeButton::B, Joycon::PadButton::B, true},
            {YuzuSettings::NativeButton::X, Joycon::PadButton::X, true},
            {YuzuSettings::NativeButton::Y, Joycon::PadButton::Y, true},
            {YuzuSettings::NativeButton::DLeft, Joycon::PadButton::Left, false},
            {YuzuSettings::NativeButton::DUp, Joycon::PadButton::Up, false},
            {YuzuSettings::NativeButton::DRight, Joycon::PadButton::Right, false},
            {YuzuSettings::NativeButton::DDown, Joycon::PadButton::Down, false},
            {YuzuSettings::NativeButton::L, Joycon::PadButton::L, false},
            {YuzuSettings::NativeButton::R, Joycon::PadButton::R, true},
            {YuzuSettings::NativeButton::ZL, Joycon::PadButton::ZL, false},
            {YuzuSettings::NativeButton::ZR, Joycon::PadButton::ZR, true},
            {YuzuSettings::NativeButton::Plus, Joycon::PadButton::Plus, true},
            {YuzuSettings::NativeButton::Minus, Joycon::PadButton::Minus, false},
            {YuzuSettings::NativeButton::Home, Joycon::PadButton::Home, true},
            {YuzuSettings::NativeButton::Screenshot, Joycon::PadButton::Capture, false},
            {YuzuSettings::NativeButton::LStick, Joycon::PadButton::StickL, false},
            {YuzuSettings::NativeButton::RStick, Joycon::PadButton::StickR, true},
        };
    ...
    if (params.Get("pad", 0) == static_cast<int>(Joycon::ControllerType::Left)) {
        ...
        mapping.insert_or_assign(YuzuSettings::NativeButton::SLLeft, std::move(sl_button_params));
        mapping.insert_or_assign(YuzuSettings::NativeButton::SRLeft, std::move(sr_button_params));
    }
    ...
    if (params.Get("pad", 0) == static_cast<int>(Joycon::ControllerType::Right)) {
        ...
        mapping.insert_or_assign(YuzuSettings::NativeButton::SLRight, std::move(sl_button_params));
        mapping.insert_or_assign(YuzuSettings::NativeButton::SRRight, std::move(sr_button_params));
    }
