...
void SDLDriver::InitJoystick(int joystick_index) {
    ...
    if (YuzuSettings::values.enable_joycon_driver) {
    ...
    if (YuzuSettings::values.enable_procon_driver) {
...
SDLDriver::SDLDriver(std::string input_engine_) : InputEngine(std::move(input_engine_)) {
    ...
    if (!YuzuSettings::values.enable_raw_input) {
...
ButtonMapping SDLDriver::GetButtonMappingForDevice(const Common::ParamPackage& params) {
    ...
    static constexpr ZButtonBindings switch_to_sdl_axis{{
        {YuzuSettings::NativeButton::ZL, SDL_CONTROLLER_AXIS_TRIGGERLEFT},
        {YuzuSettings::NativeButton::ZR, SDL_CONTROLLER_AXIS_TRIGGERRIGHT},
    }};
...
ButtonBindings SDLDriver::GetDefaultButtonBinding(
    ...
    return {
        std::pair{YuzuSettings::NativeButton::A, SDL_CONTROLLER_BUTTON_B},
        {YuzuSettings::NativeButton::B, SDL_CONTROLLER_BUTTON_A},
        {YuzuSettings::NativeButton::X, SDL_CONTROLLER_BUTTON_Y},
        {YuzuSettings::NativeButton::Y, SDL_CONTROLLER_BUTTON_X},
        {YuzuSettings::NativeButton::LStick, SDL_CONTROLLER_BUTTON_LEFTSTICK},
        {YuzuSettings::NativeButton::RStick, SDL_CONTROLLER_BUTTON_RIGHTSTICK},
        {YuzuSettings::NativeButton::L, SDL_CONTROLLER_BUTTON_LEFTSHOULDER},
        {YuzuSettings::NativeButton::R, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER},
        {YuzuSettings::NativeButton::Plus, SDL_CONTROLLER_BUTTON_START},
        {YuzuSettings::NativeButton::Minus, SDL_CONTROLLER_BUTTON_BACK},
        {YuzuSettings::NativeButton::DLeft, SDL_CONTROLLER_BUTTON_DPAD_LEFT},
        {YuzuSettings::NativeButton::DUp, SDL_CONTROLLER_BUTTON_DPAD_UP},
        {YuzuSettings::NativeButton::DRight, SDL_CONTROLLER_BUTTON_DPAD_RIGHT},
        {YuzuSettings::NativeButton::DDown, SDL_CONTROLLER_BUTTON_DPAD_DOWN},
        {YuzuSettings::NativeButton::SLLeft, sll_button},
        {YuzuSettings::NativeButton::SRLeft, srl_button},
        {YuzuSettings::NativeButton::SLRight, slr_button},
        {YuzuSettings::NativeButton::SRRight, srr_button},
        {YuzuSettings::NativeButton::Home, SDL_CONTROLLER_BUTTON_GUIDE},
        {YuzuSettings::NativeButton::Screenshot, SDL_CONTROLLER_BUTTON_MISC1},
    };
}
...
bool SDLDriver::IsButtonOnLeftSide(YuzuSettings::NativeButton::Values button) const {
    switch (button) {
...
AnalogMapping SDLDriver::GetAnalogMappingForDevice(const Common::ParamPackage& params) {
    ...
    if (params.Has("guid2")) {
        ...
        mapping.insert_or_assign(YuzuSettings::NativeAnalog::LStick,
    ...
    mapping.insert_or_assign(YuzuSettings::NativeAnalog::RStick,
...
MotionMapping SDLDriver::GetMotionMappingForDevice(const Common::ParamPackage& params) {
    ...
    if (joystick->HasMotion()) {
        mapping.insert_or_assign(YuzuSettings::NativeMotion::MotionRight,
                                 BuildMotionParam(joystick->GetPort(), joystick->GetGUID()));
    }
    if (params.Has("guid2")) {
        joystick2->EnableMotion();
        if (joystick2->HasMotion()) {
            mapping.insert_or_assign(YuzuSettings::NativeMotion::MotionLeft,
