...
using ButtonBindings =
    std::array<std::pair<YuzuSettings::NativeButton::Values, SDL_GameControllerButton>, 20>;
using ZButtonBindings =
    std::array<std::pair<YuzuSettings::NativeButton::Values, SDL_GameControllerAxis>, 2>;
...
private:
    ...
    bool IsButtonOnLeftSide(YuzuSettings::NativeButton::Values button) const;
