...
namespace YuzuSettings::NativeAnalog {
enum Values : int;
}

namespace YuzuSettings::NativeButton {
enum Values : int;
}

namespace YuzuSettings::NativeMotion {
enum Values : int;
}
 ...
 */
using AnalogMapping = std::unordered_map<YuzuSettings::NativeAnalog::Values, Common::ParamPackage>;
using ButtonMapping = std::unordered_map<YuzuSettings::NativeButton::Values, Common::ParamPackage>;
using MotionMapping = std::unordered_map<YuzuSettings::NativeMotion::Values, Common::ParamPackage>;
