...
protected:
    explicit YuzuConfig(ConfigType config_type = ConfigType::GlobalConfig);
    ...
    virtual std::vector<YuzuSettings::BasicSetting*>& FindRelevantList(YuzuSettings::Category category) = 0;
    ...
    void ReadCategory(YuzuSettings::Category category);
    void WriteCategory(YuzuSettings::Category category);
    void ReadSettingGeneric(YuzuSettings::BasicSetting* setting);
    void WriteSettingGeneric(const YuzuSettings::BasicSetting* setting);
