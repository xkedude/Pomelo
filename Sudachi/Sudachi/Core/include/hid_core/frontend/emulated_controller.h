...
using ButtonDevices =
    std::array<std::unique_ptr<Common::Input::InputDevice>, YuzuSettings::NativeButton::NumButtons>;
using StickDevices =
    std::array<std::unique_ptr<Common::Input::InputDevice>, YuzuSettings::NativeAnalog::NumAnalogs>;
using ControllerMotionDevices =
    std::array<std::unique_ptr<Common::Input::InputDevice>, YuzuSettings::NativeMotion::NumMotions>;
using TriggerDevices =
    std::array<std::unique_ptr<Common::Input::InputDevice>, YuzuSettings::NativeTrigger::NumTriggers>;
using ColorDevices =
...
using ButtonParams = std::array<Common::ParamPackage, YuzuSettings::NativeButton::NumButtons>;
using StickParams = std::array<Common::ParamPackage, YuzuSettings::NativeAnalog::NumAnalogs>;
using ControllerMotionParams = std::array<Common::ParamPackage, YuzuSettings::NativeMotion::NumMotions>;
using TriggerParams = std::array<Common::ParamPackage, YuzuSettings::NativeTrigger::NumTriggers>;
...
using ButtonValues = std::array<Common::Input::ButtonStatus, YuzuSettings::NativeButton::NumButtons>;
using SticksValues = std::array<Common::Input::StickStatus, YuzuSettings::NativeAnalog::NumAnalogs>;
using TriggerValues =
    std::array<Common::Input::TriggerStatus, YuzuSettings::NativeTrigger::NumTriggers>;
using ControllerMotionValues = std::array<ControllerMotionInfo, YuzuSettings::NativeMotion::NumMotions>;
...
public:
    ...
    static NpadStyleIndex MapSettingsTypeToNPad(YuzuSettings::ControllerType type);

    /// Converts npad type to the equivalent of controller type from settings
    static YuzuSettings::ControllerType MapNPadToSettingsType(NpadStyleIndex type);
