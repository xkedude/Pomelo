...
void AudioCore::CreateSinks() {
    const auto& sink_id{YuzuSettings::values.sink_id};
    const auto& audio_output_device_id{YuzuSettings::values.audio_output_device_id};
    const auto& audio_input_device_id{YuzuSettings::values.audio_input_device_id};
