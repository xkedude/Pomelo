...
ISystemSettingsServer::ISystemSettingsServer(Core::System& system_)
    ...
    m_system_settings.region_code =
        static_cast<SystemRegionCode>(::YuzuSettings::values.region_index.GetValue());
...
Result ISystemSettingsServer::GetDeviceNickName(
    ...
    *out_device_name = {};
    const auto device_name_buffer = ::YuzuSettings::values.device_name.GetValue().c_str();
    memcpy(out_device_name->data(), device_name_buffer,
           ::YuzuSettings::values.device_name.GetValue().size());
...
Result ISystemSettingsServer::SetDeviceNickName(
    ...
    ::YuzuSettings::values.device_name = device_name;
    R_SUCCEED();
}
