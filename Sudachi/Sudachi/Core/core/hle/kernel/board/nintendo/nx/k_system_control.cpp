...
u32 GetMemorySizeForInit() {
    switch (YuzuSettings::values.memory_layout_mode.GetValue()) {
    case YuzuSettings::MemoryLayout::Memory_4Gb:
        return Smc::MemorySize_4GB;
    case YuzuSettings::MemoryLayout::Memory_6Gb:
        return Smc::MemorySize_6GB;
    case YuzuSettings::MemoryLayout::Memory_8Gb:
