...
std::optional<NetworkInterface> GetSelectedNetworkInterface() {
    const auto& selected_network_interface = YuzuSettings::values.network_interface.GetValue();
...
void SelectFirstNetworkInterface() {
    ...
    YuzuSettings::values.network_interface.SetValue(network_interfaces[0].name);
}
